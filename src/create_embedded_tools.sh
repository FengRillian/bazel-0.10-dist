...
for i in $*; do
  ...
  case "$i" in
    ...
    *javac-9-dev-r4023-3.jar) OUTPUT_PATH=third_party/java/jdk/langtools/javac-9-dev-r4023-3.jar ;;
...
if [ ! -f ${PACKAGE_DIR}/third_party/java/jdk/langtools/javac-9-dev-r4023-3.jar ]; then
  cp ${PACKAGE_DIR}/third_party/java/jdk/langtools/javac7.jar \
      ${PACKAGE_DIR}/third_party/java/jdk/langtools/javac-9-dev-r4023-3.jar
fi
